...
<div>
    <div class="widget-box profileBG">
        <div>
            <p class="header blue">
                Transfer from here <br> deducts from your e-Wallet
            </p>
            <br>

            <div class="row">
                <div id="rowAll">
                    <div class="col-xs-12 col-md-4 col-md-offset-4 widget-container-col" id="widget-container-col-5">
                        <div class="widget-box" id="widget-box-5">
                            <div class="widget-header">
                                <h5 class="widget-title bolder">YOUR e-WALLET BALANCE</h5>
