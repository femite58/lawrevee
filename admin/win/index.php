...
if(isset($_POST['tk'])) {
 ...
 $_SESSION["ticket"] = sanitizeInput($_POST['tk']);
            ...
            <section id="contact-us" class="index-2">
               <div class="container">
                  ...
                  <div class="content">
					  ...
					  <br><br>
					  <h4 class="text-center">Raffle Draw </h4>
					  <p class="text-center">Please enter your ticket number below</p>
					  <br>
                     <div class="row">
                    <form method="post">
                        <div class="col-md-12 contact-form">
                           
                              <div class="col-md-6 col-offset-md-3 form-group">
                                 <input type="text" placeholder="Ticket Number" name="tk" required value="<?php echo @$_GET['tk']; ?>"/>
                              </div>
